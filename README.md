# AI Training Workshop for DOST Researchers
...
| Topic | File |
|-------|------|
| Hyperparameter Tuning | `activity_01_hyperparameter_tuning.py` |
| Cross-Validation Strategies | `activity_02_cross_validation_strategies.py` |
| Feature Engineering | `activity_03_feature_engineering.py` |
